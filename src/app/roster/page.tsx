            ...
            <div className="bg-white rounded-2xl max-w-lg w-full p-6 shadow-2xl border border-slate-100 my-8 space-y-4">
              ...
              <div className="space-y-1.5">
                ...
                <textarea
                  ...
                  placeholder="例如：課堂邏輯推演表現優異..."
                  className="w-full p-3 border border-slate-300 rounded-xl text-sm focus:ring-2 focus:ring-sky-700 focus:outline-none resize-y leading-relaxed text-slate-800 font-mono"
                />
              </div>
